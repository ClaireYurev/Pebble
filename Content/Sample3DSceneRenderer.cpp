...
#include "Cube.h" // Include the new Cube class
...
void Sample3DSceneRenderer::CreateDeviceDependentResources()
{
    ...
    auto createAssetsTask = createPipelineStateTask.then([this]() {
        ...
        // Use the Cube class to get the vertices and indices.
        Cube cube;
        const auto& cubeVertices = cube.GetVertices();
        const auto& cubeIndices = cube.GetIndices();

        const UINT vertexBufferSize = static_cast<UINT>(cubeVertices.size() * sizeof(VertexPositionColor));
        ...
        // Upload the vertex buffer to the GPU.
        {
            ...
            vertexData.pData = reinterpret_cast<const BYTE*>(cubeVertices.data());
        ...
        const UINT indexBufferSize = static_cast<UINT>(cubeIndices.size() * sizeof(unsigned short));
        ...
        // Upload the index buffer to the GPU.
        {
            ...
            indexData.pData = reinterpret_cast<const BYTE*>(cubeIndices.data());
